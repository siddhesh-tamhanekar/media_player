...
/**
 * And implementation of {@link EventChannel.EventSink} which can wrap an
 * underlying sink.
 *
 * <p>
 * It delivers messages immediately when downstream is available, but it queues
 * messages before the delegate event sink is set with setDelegate.
 *
 * <p>
 * This class is not thread-safe. All calls must be done on the same thread or
